...
def main():
    ...
    # 加载音乐
    begin_music = pygame.mixer.Sound('music/begin_music.mp3')
    playing_music = pygame.mixer.Sound('music/playing_music.mp3')
    collision_music = pygame.mixer.Sound('music/collision_music.mp3')

    # 开始播放开始界面的音乐
    begin_music.play(-1)  # -1 表示循环播放
